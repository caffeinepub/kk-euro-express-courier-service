          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                ...
                tailored to your unique requirements. Whether you're a small
                business or a large enterprise, we can design a service package
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                ...
                coverage and real-time tracking. Monitor your packages from
                pickup to delivery with instant notifications at every step.
              </p>
              <ul className="space-y-2 text-muted-foreground">
      ...
      <Section className="bg-muted/30">
        <div className="rounded-2xl bg-gradient-to-r from-primary to-accent p-12 text-center text-primary-foreground">
          ...
          <p className="mb-8 text-lg text-white/90 max-w-2xl mx-auto">
            Our team is ready to help you find the perfect shipping solution for
            your needs. Contact us today for a personalized quote and expert
            advice.
          </p>
